...
public class PrettyPrintVisitor implements Visitor {
	...
	public ArrayList<String> jNames; // store the .j names of a javacode file

	public PrettyPrintVisitor() {
		jNames = new ArrayList<>();
	}
	...
	@Override
	// Load a constant(int,float,String)
	...
	public void visit(codegen.bytecode.stm.New s) {
		...
		// MyQuestion:is it need to store now?
		return;
	}
	...
	public void visit(codegen.bytecode.type.Class t) {
		this.say("L" + t.id + ";"); // why should we add a 'L'?
	}
	...
	@Override
	public void visit(codegen.bytecode.stm.Ixor xor) {
		// TODO Auto-generated method stub
		this.isayln("ixor");
	}
	...
	@Override
	public void visit(codegen.bytecode.stm.Ifeq ifeq) {
		// TODO Auto-generated method stub
	...
	public void visit(codegen.bytecode.stm.Getfield s) {
		// TODO Auto-generated method stub
		String type = typeConvert(s.fieldType);
		this.isayln("getfield " + s.fieldLoc + " " + type);
	}
	...
	public void visit(codegen.bytecode.stm.Putfield s) {
		// TODO Auto-generated method stub
		String type = typeConvert(s.fieldType);
		this.isayln("putfield " + s.fieldLoc + " " + type);
	}

	public String typeConvert(String fieldType) {
		String type = "";
		switch (fieldType) {
		case "@int":
			type = "I";
